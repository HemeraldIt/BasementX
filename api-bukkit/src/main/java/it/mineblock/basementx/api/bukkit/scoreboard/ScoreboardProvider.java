...
import it.mineblock.basementx.api.bukkit.scoreboard.board.task.ScoreboardUpdateTask;
import it.mineblock.basementx.api.bukkit.scoreboard.builder.ScoreboardBuilder;
