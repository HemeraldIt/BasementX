...
public class BasementConfig implements SettingsHolder {
    ...
    public static final Property<String> SERVER_ID = newProperty("server_name", "unknown");

    public static final Property<String> REDIS_HOST = newProperty("redis.host", "redis0");
