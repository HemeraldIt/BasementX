package it.hemerald.basementx.common.nms.v1_18_R2.scoreboard;
...
public class ScoreboardUtils implements it.hemerald.basementx.api.bukkit.scoreboard.ScoreboardUtils {
    ...
    public PacketPlayOutScoreboardObjective createObjectivePacket(int mode, String name, String displayName) {
        try {
            ...
            return new PacketPlayOutScoreboardObjective(new ScoreboardObjective(null,
                    name, null, IChatBaseComponent.a(displayName), IScoreboardCriteria.EnumScoreboardHealthDisplay.a), mode);
    ...
    public PacketPlayOutScoreboardTeam createTeamPacket(int mode, String name, @Nullable String prefix, @Nullable String suffix) {
        ...
        try {
            ...
            setFieldValue(options, "a", IChatBaseComponent.a(""));
            setFieldValue(options, "b", IChatBaseComponent.a(prefix != null ? prefix : ""));
            setFieldValue(options, "c", IChatBaseComponent.a(suffix != null ? suffix : ""));
