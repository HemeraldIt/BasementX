package it.hemerlad.basementx.api;

import lombok.NonNull;
import org.jetbrains.annotations.ApiStatus;

public final class BasementProvider {
    private static Basement instance = null;
    ...
    /**
     * Gets an instance of the {@link Basement} API,
    ...
    @ApiStatus.Internal
    public static void register(Basement instance) {
